...
/// to stderr
pub struct DebugCodeRead<CR: BVGraphCodesReader> {
    pub cr: CR,
}

impl<CR: BVGraphCodesReader> DebugCodeRead<CR> {
    pub fn new(cr: CR) -> Self {
        Self { cr }
    }
}

impl<CR: BVGraphCodesReader> BVGraphCodesReader for DebugCodeRead<CR> {
