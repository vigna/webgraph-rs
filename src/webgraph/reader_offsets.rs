use super::*;
use crate::{utils::nat2int, prelude::{BufferedBitStreamRead, MemWordReadInfinite}};
use core::iter::Peekable;
use anyhow::Result;

pub struct WebgraphReaderSequentialOffsets<CR: WebGraphCodesReader> {
    codes_reader: CR,
...
impl<CR: WebGraphCodesReader> WebgraphReaderSequential<CR> {
    ...
    fn next_successors(&mut self) -> Result<&[u64]> {
