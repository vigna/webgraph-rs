...
pub fn main() -> Result<()> {
    ...
    /*  TODO
    webgraph::graph::bvgraph::parallel_compress_sequential_iter::<_, WebgraphSequentialIter<DynamicCodesReaderBuilder<BE, MmapBackend<u32>>>>(
        args.new_basename,
        &mut seq_graph.iter_nodes()
        seq_graph.num_nodes(),
        compression_flags,
