...
/// Autogenerated tables for unary code by build.rs
pub mod unary_tables {
    include!(concat!(env!("OUT_DIR"), "/unary_tables.rs"));
}
/// Autogenerated tables for gamma code by build.rs
pub mod gamma_tables {
    include!(concat!(env!("OUT_DIR"), "/gamma_tables.rs"));
}
/// Autogenerated tables for delta code by build.rs
pub mod delta_tables {
    include!(concat!(env!("OUT_DIR"), "/delta_tables.rs"));
}
/// Autogenerated tables for zeta code by build.rs
pub mod zeta_tables {
    include!(concat!(env!("OUT_DIR"), "/zeta_tables.rs"));
}
