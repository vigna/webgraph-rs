...
#[inline(always)]
/// Autogenerated function to lookup a read table
...
def gen_unary(read_bits, write_max_val, len_max_val=None, merged_table=True):
...
def gen_gamma(read_bits, write_max_val, len_max_val=None, merged_table=True):
...
def gen_delta(read_bits, write_max_val, len_max_val=None, merged_table=True):
...
def gen_zeta(read_bits, write_max_val, len_max_val=None, k=3, merged_table=True):
    """Configuration of `gen_table` for delta"""
    len_max_val = len_max_val or write_max_val
    gen_table(
        read_bits, write_max_val, len_max_val,
